    ...
    <main className="relative grain">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-4 py-4">
        <div className="max-w-7xl mx-auto">
          <div className="glass rounded-full px-6 py-3 flex items-center justify-between">
            <Link href="/" className="font-display text-2xl tracking-widest uppercase hover:opacity-70 transition-opacity">
              {artist?.name || "Heiraza"}
            </Link>
            <div className="hidden md:flex items-center gap-8">
              ...
              {settings?.isShopVisible && <Link href="#shop" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">Shop</Link>}
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden gradient-warm-bg">
        ...
        <div className="relative z-30 text-center px-6 max-w-5xl mx-auto">
          <p className="opacity-0 animate-fade-in text-sm md:text-base font-medium tracking-[0.3em] uppercase text-muted-foreground mb-6">
            Welcome to the world of
          </p>
          <h1 className="opacity-0 animate-fade-in animate-delay-100 font-display text-display-xl tracking-widest uppercase">
            {artist?.name || "Heiraza"}
          </h1>
          <p className="opacity-0 animate-fade-in animate-delay-200 mt-8 text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed font-serif italic">
